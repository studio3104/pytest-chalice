# -*- coding: utf-8 -*-
#
# pytest-chalice documentation build configuration file, created by
...
project = u'pytest-chalice'
copyright = u'2015, Satoshi SUZUKI'
author = u'Satoshi SUZUKI'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-chalice Documentation',
     [author], 1)
]
